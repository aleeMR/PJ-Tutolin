...
const AccountPage = () => {
    ...
    const createTutor = () => {
        ...
        axios.post(`${ process.env.REACT_APP_SERVER }/api/tutors/${ user.id }`, dataTutor, {
                headers: {
                    'x-access-token': localStorage.getItem('tl-token')
                }
            })
        ...
        axios.put(`${ process.env.REACT_APP_SERVER }/api/tutors/${ user.id }`, img, {
                headers: {
                    'x-access-token': localStorage.getItem('tl-token'),
    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <form onSubmit={ handleSubmit } encType="multipart/form-data" className="lg:w-3/6 md:w-1/2 bg-gray-100 rounded-lg px-11 py-8 mx-auto md:ml-auto w-full mt-10 md:mt-0">
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-10">
                                <div className="row-span-2">
                                    ...
                                    <div className="mt-1 flex items-center">
                                        <img src={ image ? image : require("../assets/img/avatar.png") } className="rounded-full overflow-hidden border border-gray-300" />
