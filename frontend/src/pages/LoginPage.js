        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col mx-auto shadow md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <Button link={routes.login} style_extra="mt-7 mb-10 text-gray-400 hover:text-gray-900" style_button="w-full px-8 py-2 text-white text-lg bg-color-2" option="Ingresar" />
